    ...
    <div>
      <div className="card" style={{ maxWidth: 560 }}>
        ...
        <p style={{ fontSize: 13, color: "var(--ink-soft)", marginBottom: 16 }}>
          อัปโหลดไฟล์ .xlsx หรือ .xls ที่ดึงออกมาจากเครื่องสแกนนิ้วได้เลย (หัวตารางแบบ "รหัสนิ้วมือ", "ชื่อ-สกุล", "วันที่",
          "เข้างาน", "ออกงาน") ไม่ต้องจัดรูปแบบใหม่ — ระบบจะอ่าน "เข้างาน"/"ออกงาน" เป็นเวลาสแกนจริง (ไม่ใช่ "เวลาเข้า"/"เวลาเลิก"
          ที่เป็นแค่เวลากะที่ตั้งไว้) ถ้าเลขนิ้วมือยังไม่มีในระบบ จะสร้างลูกจ้างใหม่ให้อัตโนมัติ (ค่าจ้าง/วัน ตั้งต้นที่ 350 บาท แก้ทีหลังได้ที่
